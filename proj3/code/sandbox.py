...
from proj1_1.code.se3_control_custom import SE3Control_custom
...
if my_world_traj.path is not None:
    world.draw_line(ax, my_world_traj.path, color='blue')
    world.draw_points(ax, my_world_traj.path, color='blue')
plt.show()
"""
